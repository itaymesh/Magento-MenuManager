...
class Studioraz_MenuManager_Model_Item_Renderer_Page extends Studioraz_MenuManager_Model_Item_Renderer_Abstract {


	protected function _render() {

		$this->setValue(Mage::getUrl($this->getItem()->getCmsPage()));
		parent::_render();
