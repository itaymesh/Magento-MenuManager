...
class Studioraz_MenuManager_Model_Item_Renderer_Category extends Studioraz_MenuManager_Model_Item_Renderer_Abstract {
	...
	protected function _render() {
		$this->setValue(Mage::getModel('catalog/category')->load($this->getItem()->getCategoryId())->getUrl());
